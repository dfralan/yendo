        ...
        fetch(url)
            ...
            .then(rep => {
                ...
                Categories.forEach((category, index) => {
                    ...
                    let categoryElement = `
                        <div style="background-color: #1B406B;" class="w-fit color-white padded font-500">
                            ${category}
                        </div>
                ...
                Products.forEach((Product) => {
                    ...
                    if (parentDiv) {
                        ...
                        if (productContainerDiv) {
                            ...
                            const estado = (Product.Estado !== 'Disponible' && Product.Estado !== '') ? '' : `<span class='font-s font-300 xs-padded rounded-s bg-black color-white'>${Product.Estado}</span>`
