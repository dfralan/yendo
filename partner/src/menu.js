            ...
            .then(rep => {
                ...
                Categories.forEach((category, index) => {
                    ...
                    let categoryElement = `
                        ...
                        <div class="productContainer w-100 display-flex flex-col s-gap">
                        </div>
                    `
                ...
                Products.forEach((Product) => {
                    ...
                    if (parentDiv) {
                        ...
                        if (productContainerDiv) {
                            ...
                            const estado = (Product.Estado !== 'Disponible' && Product.Estado !== '') ? '' : `<span class='font-s font-400 rounded-s bg-black color-white'>${Product.Estado}</span>`

                            
                            let productElement = `
                                <div class="w-100 display-flex flex-col s-gap">
                                    <div style='border-color: #1B406B; color: #1B406B' class='display-flex h-center flex-row spaced border-solid border-left-none border-right-none border-top-none'>
                                        <h3 class="font-500 width-fit wrap overflow-scroll s-padded no-padded-left">
                                            ${Product.Plato}
                                            ${estado}
                                        </h3>
