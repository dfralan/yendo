...
function foreach(categories) {
  ...
  categoriesN ++
    ...
    const categoryHTML = `
      <small onclick="toggleMe(this)" style="border-width: 1px ;border-color: #0D7A5F; color: #0D7A5F;" class="popularCategoryItem cursor-pointer no-wrap font-500 decoration-none color-black rounded-s border-solid xs-padded bg-none">
        ${category.nombre}
      </small>
    `;
    const HidedCategoryHTML = `
      <small onclick="toggleMe(this)" style="border-width: 1px ;border-color: #0D7A5F; color: #0D7A5F;" class="categoryItem cursor-pointer display-none no-wrap font-500 decoration-none color-black rounded-s border-solid xs-padded bg-none">
        ${category.nombre}
      </small>
    `;
