...
function foreach(categories) {
  ...
  let html = `
  <h4 class="no-wrap font-500 decoration-none color-tertiary xs-padded">
        Tendencias:
  </h4>
  `;
  ...
  categoriesN ++
    ...
    const categoryHTML = `
      <h4 data-code='${category.codigo}' class="popularCategoryItem cursor-pointer no-wrap font-500 decoration-none color-white">
        ${category.nombre}, 
      </h4>
    `;
    const HidedCategoryHTML = `
      <h4 data-code='${category.codigo}' class="categoryItem cursor-pointer display-none no-wrap font-500 decoration-none color-white rounded-s border-solid xs-padded">
        ${category.nombre}, 
      </h4>
    `;
  ...
  const expandToAllCategories = `<p onclick="toggleCategories()" id='categoriesToggler' class='font-400 cursor-pointer fill-white'>
